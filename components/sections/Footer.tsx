...
export default function Footer() {
  return (
    <footer className="relative border-t border-ink/10 px-[7vw] py-[50px]" style={{ background: "#e8dcc6" }}>
      <div className="mx-auto flex max-w-[1200px] flex-wrap items-center justify-between gap-6">
        <div className="flex items-center gap-[13px]">
          ...
          <div>
            <div className="font-display text-sm font-bold tracking-[0.14em] text-ink">
              ASHUTOSH SAGAR
            </div>
        ...
        <div className="flex flex-wrap gap-[26px] text-xs tracking-[0.2em] text-[#7a6a55] uppercase">
          {LINKS.map((link) => (
        ...
        <div className="font-mono text-[11px] text-[#9a8a70]">© 2026 · Portfolio Quest</div>
      </div>
    </footer>
  );
}
